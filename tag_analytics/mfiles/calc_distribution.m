...
print(h,'-dpng','-color','~/Dropbox/Alan - Doutorado/Tese Text/tese/images/tag_once_dist.png')
...
print(h,'-dpng','-color','~/Dropbox/Alan - Doutorado/Tese Text/tese/images/tags_per_dataset.png')
...
print(h,'-dpng','-color','~/Dropbox/Alan - Doutorado/Tese Text/tese/images/similarity.png')
